...
class WallModel extends ModelEntity {
  constructor() {
    super();
    this.currentTier = 1;
    this.base = new SpriteEntity('/asset/image/entity/wall/wall-t1-base.svg');
  ...
  updateModel(tick, networkEntity) {
    ...
    switch (this.currentTier) {
      ...
      case 8:
      case 9:
        this.base = new SpriteEntity('/asset/image/entity/wall/wall-t' + this.currentTier + '-base.svg');
        break;
      default:
